...
public class ThrivingRubyLand extends AbstractEasyCard {
    public ThrivingRubyLand() {
        super(makeID("ThrivingRubyLand"), 0, CardType.SKILL, CardRarity.UNCOMMON, CardTarget.NONE, CharacterFile.Enums.NEMDRUID_COLOR);
        baseMagicNumber = 1;
        baseSecondMagic = 5;
        this.exhaust = true;
    ...
    public void onChoseThisOption() {
        addToBot(new ChannelAction(new TapMox(0,2,0)));
