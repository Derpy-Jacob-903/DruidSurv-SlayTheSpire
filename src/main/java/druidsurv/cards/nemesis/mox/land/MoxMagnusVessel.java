...
public class MoxMagnusVessel extends AbstractPowerCostCard {
    public MoxMagnusVessel() {
        super(makeID("MoxMagnusVessel"), 3, CardType.SKILL, CardRarity.RARE, CardTarget.NONE, CharacterFile.Enums.NEMDRUID_COLOR);
        baseMagicNumber = 1;
        baseSecondMagic = 10;
        this.exhaust = true;
    ...
    public void onChoseThisOption() {
        ...
        addToBot(new ChannelAction(new TapMox(1,1,1)));
    }
