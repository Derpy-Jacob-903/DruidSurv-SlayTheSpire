...
public class MoxRuby extends AbstractEasyCard {
    public MoxRuby() {
        super(makeID("MoxRuby"), 1, CardType.SKILL, CardRarity.COMMON, CardTarget.NONE, CharacterFile.Enums.NEMDRUID_MOX_COLOR);
        baseMagicNumber = 1;
        baseSecondMagic = 5;
        baseBlock = 5;
