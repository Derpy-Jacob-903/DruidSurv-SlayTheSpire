...
@AutoAdd.Ignore
@Deprecated
public class ArcaneBlast extends AbstractEasyCard {
    public final static String ID = makeID("ArcaneBlast");
    // intellij stuff attack, enemy, basic, 6, 3,  , , ,

    public ArcaneBlast() {
        super(ID, 2, CardType.ATTACK, CardRarity.BASIC, CardTarget.ENEMY, CharacterFile.Enums.NEMDRUID_COLOR);
        baseDamage = 10;
        damage = baseDamage;
        baseMagicNumber = 1;
