...
public class DruidDeck extends AbstractEasyRelic {
    public static final String ID = makeID("DruidDeck");
    ...
    public void atTurnStart() {
        AbstractPlayer p = AbstractDungeon.player;
        addToBot((AbstractGameAction) new ApplyPowerAction(p, p, (AbstractPower) new FocusPower(p, 1), 1, true, AbstractGameAction.AttackEffect.NONE));
    }

    public boolean canSpawn() {
        return AbstractDungeon.player.hasRelic(makeID("BlankDeck"));
    }
