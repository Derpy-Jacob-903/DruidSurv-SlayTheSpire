...
public class PowerPotion extends AbstractEasyPotion {
    public static String ID = makeID("PowerPot");
    ...
    public void use(AbstractCreature creature) {
        ...
        ArrayList<AbstractCard> eligibleCardsList = getCardsMatchingPredicate(c -> c.hasTag(CardTags.BCSPOWER), true);
