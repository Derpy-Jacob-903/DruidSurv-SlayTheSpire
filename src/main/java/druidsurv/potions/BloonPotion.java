...
public class BloonPotion extends AbstractEasyPotion {
    public static String ID = makeID("BloonPot");
    ...
    public void use(AbstractCreature creature) {
        ...
        ArrayList<AbstractCard> eligibleCardsList = getCardsMatchingPredicate(c -> c.hasTag(CardTags.BLOON), true);
